...
//		this.add(mainPanel);
////		ImageIcon img = new ImageIcon("images/mazim.jpg");
////		Image hi = img.getImage();
////		this.setIconImage(hi);
//		
//		initActions();
//		initMenuScreen();
//		initGameScreen();
...
//		initCardLayout();
//		
//		this.setSize(620, 548);
//		this.setMinimumSize(new Dimension(620,548));
...
//		frame.setMinimumSize(new Dimension(620,548));
//		frame.pack();
//	}
//	
...
//		howToPlay.setPreferredSize(new Dimension(500,400));
...
//				frame.setMinimumSize(new Dimension(421,348));
//				frame.setSize(new Dimension(421,348));
//				frame.pack();
//			}
//		};
//		
...
//				menuScreen.requestFocusInWindow();
//				gameScreen.getComponent(1).requestFocus();
//				frame.setMinimumSize(new Dimension(521,448));
//				frame.setSize(new Dimension(521,448));
//				frame.pack();
//			}
//		};
//		
